...
module.exports = {
    ...
    PHONE: process.env.NUMBER === undefined ? '+919605101516' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'STATUS HUB' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By BOT' : process.env.ALL_CAPTION,
    ...
    MENTION: process.env.TAG_REPLY === undefined ? '919605101516@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ sᴛᴀᴛᴜs ʜᴜʙ ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
